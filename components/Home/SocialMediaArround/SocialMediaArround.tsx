  ...
  return (
    <>
      <motion.div
        ...
        className="z-10 fixed bottom-0 left-0  hidden xl:flex flex-row px-12 items-center justify-between  "
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/Smkhizar7"}
            />
            {/* Linkedin icon */}
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
              href={
                "https://www.linkedin.com/in/shaikh-muhammad-khizar-98516b1b7/"
              }
            />
            {/* Instagram Icon */}
      ...
      <motion.div
        ...
        className="z-10 fixed bottom-0 -right-10 hidden xl:flex flex-row items-center justify-between"
      >
        <div className="flex flex-col space-y-36 justify-center items-center">
          ...
          >
            <a
              href="mailto:shaikh.muhammad.khizar@gmail.com"
              target={"_blank"}
              rel="noreferrer"
            >
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                ...
                <span className="text-AAsecondary">@</span>gmail
